        ...
        <>
          ...
          <section className="comparison-section">
            <div className="section-heading">
              <p className="eyebrow">Analisis operativo</p>
              <h2>Antes y despues del analisis</h2>
            </div>
            ...
            <div className="comparison-grid">
              <section className="analysis-block">
                ...
                <p>
                  Informacion original obtenida desde Zabbix mediante
                  problem.get. Se muestra sin interpretacion adicional para
                  evidenciar el punto de partida tecnico.
                </p>
                <RawEventsTable
                  problems={problems}
              ...
              <section className="analysis-block analysis-block-strong">
                ...
                <p>
                  ...
                  enriquecen con categoria, explicacion, mantenimiento sugerido
                  y primera accion recomendada.
                </p>
          ...
          <section className="predictive-note">
            ...
            <p>
              El sistema identifica recurrencia, severidad y senales operativas
              para apoyar mantenimiento preventivo, predictivo y correctivo. No
              afirma prediccion exacta de fallas.
            </p>
          </section>
        </>
      )}
